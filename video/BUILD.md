...
- 1920×1080 / 30fps / 9분 48초 / H.264 + AAC
- 원본 135MB (1.93 Mbps), 경량본 94MB (1.33 Mbps, faststart)
- 렌더: 17,652 프레임, 8분 30초 (beginframe capture, 워커 4)

렌더 호스트 메모: 이 환경에서는 sandbox_exec 호출이 실행 중인 렌더를 죽인다.
띄워놓고 끝날 때까지 아예 건드리지 말 것. 중간에 확인하면 그 시점에 죽는다.
